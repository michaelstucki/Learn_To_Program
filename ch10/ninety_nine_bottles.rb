...
def bottles_song(bottles)
  while bottles > 0
    bottles_english = english_number(bottles).capitalize.strip
    puts "#{bottles_english} #{bottles == 1 ? "bottle" : "bottles"} of beer on the wall!" 
    puts "#{bottles_english} #{bottles == 1 ? "bottle" : "bottles"} of beer!" 
